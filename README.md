...
For systems not listed above, you might need to exit them using the Steam button menu option, the system Exit hotkey (Steam-B(hold)), and/or
bind Alt-F4 or other exit hotkey (depending on the emulator) to some Steam Deck input.
